...
Create index clix_cliente_nome_razao2 on cltb_cliente using btree( nome_razao );
Create index clix_cliente_rg_inscr2 on cltb_cliente using btree( rg_inscr );
Create index clix_cliente_cpf_cnpj2 on cltb_cliente using btree( cpf_cnpj );
Create index clix_cliente_dia_pagto_nome_raz2 on cltb_cliente using btree( dia_pagamento,nome_razao );
Create index prix_produto_nome2 on prtb_produto using btree( nome );
Create index cbix_cliente_produto_idc_idp2 on cbtb_cliente_produto using btree( id_cliente,id_produto );
Create index cnix_conta_idc22 on cntb_conta using btree( id_cliente );
