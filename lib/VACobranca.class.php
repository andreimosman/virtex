	...
	// geração de faturas
		...
		if ($acao == "listar"){
			...
			$total_parc_format = number_format($total_parc, 2, '.', '');
				...
				/*echo "
				<form id='form_fix' name='form_fix' method='post' action=''>
				 <table border='1' align='center' cellpadding='0' cellspacing='0' width='550'>
					<tr>
					  <td align='center' width='110'>COD</td>
					  <td align='center' width='110'>NOME</td>
					  <td align='center' width='110'>QUANT</td>
					  <td align='center' width='110'>PRE&Ccedil;O UNI</td>
					  <td align='center' width='110'>TOTAL</td>
					</tr>
					<tr>
					  <td align='center'>$id_produto </td>
					  <td align='center'>$nome</td>
					  <td align='center'>$quant</td>
					  <td align='center'>$valor</td>
					  <td align='center'>$total_parc</td>
					</tr>
				</table>
				";*/
