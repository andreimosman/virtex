<?
	...
	if(count($lista_user) && $lista_user["username"]){
		// ver como processar 
		$erros[] = "Jс existe outra conta cadastrada com esse username";
	}

	//se nуo tiver erros continua a formaчуo do contrato
	//Pega todas a informaчѕes necessсrias deste aformuilсrio para a continuaчуo da contrataчуo
	...
	if( !count($erros) ) {
		...
		//Informaчѕes de banco e cartуo de crщdito
		...
		//Informaчѕes referente ao cliente e ao produto
		...
		//Formataчуo de valores monetсrris
		...
		//Joga Informaчѕes para o template
		//Variсveis de utilizaчуo do script de contrataчуo
		...
		//Adquire informaчѕes adicionais do produto e os envia para o template
		switch($tipo) {
			case 'D':
		...
		switch($tipo){
		case "BL":
		$msg_final = "Existe outro usuсrio de Banda Larga cadastrado com esses dados!";
		break;
		case "E":
