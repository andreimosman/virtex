					...
					switch($forma_pagamento) {
						case 'POS':
								...
								for ($i=0; $i < $vigencia; $i++) {									
									...
									//Primeira fatura é a taxa de instalação
									if($i==0) {
									...
									if($qt_descontos > 0 && $fatura_adesao != 't') {
									...
									$sSQL .= "	$fatura_pg_acrescimo, $fatura_vl_pago, '$fatura_adesao' ";
									$sSQL .= ")";
