...
// +----------------------------------------------------------------------+
//
// $Id: pearcmd.php,v 1.1 2006/12/13 11:47:22 publish Exp $
 ...
 * @nodep Gtk
 */
if ('/usr/local/lib/php/pear' != '@'.'include_path'.'@') {
    ini_set('include_path', '/usr/local/lib/php/pear:/usr/local/share/pear');
    $raw = false;
} else {
